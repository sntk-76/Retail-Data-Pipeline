...
with DAG (
    dag_id = 'bucket_raw_data_to_bigquery',
    description='automate the process of the loading raw_data to the big query dataset from the storage bucket',
    ...
    transfer_file = GCSToBigQueryOperator(
        ...
        source_objects=['raw/retail_raw_data.csv'],
        destination_project_dataset_table='retail-data-pipeline-453817.retail_data_pipeline_dataset.retail_raw_data',
        source_format='CSV',
